...
#define MCSLOG_LOG(...) ::mcs::utils::log::mcslog::log(__VA_ARGS__)
#define MCSLOG_TRACE(...) \
    ::mcs::utils::log::mcslog::trace(std::source_location::current(), __VA_ARGS__)
#define MCSLOG_DEBUG(...) \
    ::mcs::utils::log::mcslog::debug(std::source_location::current(), __VA_ARGS__)
#define MCSLOG_INFO(...) \
    ::mcs::utils::log::mcslog::info(std::source_location::current(), __VA_ARGS__)
#define MCSLOG_WARN(...) \
    ::mcs::utils::log::mcslog::warn(std::source_location::current(), __VA_ARGS__)
#define MCSLOG_ERROR(...) \
    ::mcs::utils::log::mcslog::error(std::source_location::current(), __VA_ARGS__)
#define MCSLOG_FATAL(...) \
    ::mcs::utils::log::mcslog::fatal(std::source_location::current(), __VA_ARGS__)
