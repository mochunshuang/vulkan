...
struct S
{
    ...
    void bar(this S &self)
    {
        self.data = 2;
    }
    void fool()
    {
        this->data = 2; // NOTE: this 应该是这个指针导致的。大小很大
    }
};
...
int main()
{
    ...
    static_assert(sizeof(&S::getData) == 2 * sizeof(void *));

    static_assert(sizeof(&S::fool) == 2 * sizeof(void *));
    static_assert(sizeof(&S::bar) == 1 * sizeof(void *));
}
// NOLINTEND