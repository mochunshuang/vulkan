...
struct any_storage
{
    ...
    struct storage_ops
    {
        ...
        // slot func
        void (*invoke)(const void *slot_store, void *parms) noexcept;
  ...
  private:
    ...
    static constexpr const storage_ops *create_ops() noexcept
    {
        static const auto vt = storage_ops{
            ...
            .invoke =
                [](const void *ptr, void *parms) static constexpr noexcept {
                    const any_storage *self = static_cast<const any_storage *>(ptr);
                    ...
                    Obj_t *obj = std::bit_cast<Obj_t *>(self->obj_);
                    Func_t &fun_ref = *(self->template get_pointer<Func_t>(
                        const_cast<any_storage *>(self)));
