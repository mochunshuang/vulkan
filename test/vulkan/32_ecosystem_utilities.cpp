...
class HelloTriangleApplication
{
  ...
  private:
    ...
    void initWindow()
    {
        ...
        window = glfwCreateWindow(WIDTH, HEIGHT, "Vulkan Compatibility Example", nullptr,
                                  nullptr);
    ...
    void initVulkan()
    {
        ...
        std::cout << "- Dynamic Rendering: "
                  << (appInfo.dynamicRenderingSupported ? "Yes" : "No") << "\n";
        std::cout << "- Timeline Semaphores: "
                  << (appInfo.timelineSemaphoresSupported ? "Yes" : "No") << "\n";
        std::cout << "- Synchronization2: "
                  << (appInfo.synchronization2Supported ? "Yes" : "No") << "\n";
    }
    ...
    void recreateSwapChain()
    {
        ...
        // Recreate traditional render pass and framebuffers if dynamic rendering is not
        // supported
        if (!appInfo.dynamicRenderingSupported)
        {
            createRenderPass();
    ...
    void createGraphicsPipeline()
    {
        vk::raii::ShaderModule shaderModule =
            createShaderModule(readFile("shaders/27_shader_depth.spv"));
    ...
    void copyBufferToImage(const vk::raii::Buffer &buffer, const vk::raii::Image &image,
    ...
    void recordCommandBuffer(uint32_t imageIndex)
    {
        ...
        if (appInfo.dynamicRenderingSupported)
        {
            ...
            if (appInfo.synchronization2Supported)
            {
                ...
                std::array<vk::ImageMemoryBarrier2, 3> barriers = {
                    colorBarrier, depthBarrier, swapchainBarrier};
            ...
            vk::RenderingInfo renderingInfo{.renderArea = {{0, 0}, swapChainExtent},
                                            .layerCount = 1,
                                            .colorAttachmentCount = 1,
        ...
        else
        {
            ...
            commandBuffers[currentFrame].beginRenderPass(renderPassInfo,
    ...
    void createSyncObjects()
    {
        ...
        if (appInfo.timelineSemaphoresSupported)
        {
            ...
            vk::SemaphoreCreateInfo semaphoreInfo{.pNext = &timelineCreateInfo};
    ...
    void drawFrame()
    {
        ...
        auto [result, imageIndex] = swapChain.acquireNextImage(
            UINT64_MAX, *presentCompleteSemaphore[currentFrame], nullptr);
        ...
        if (appInfo.timelineSemaphoresSupported)
        {
            ...
            vk::TimelineSemaphoreSubmitInfo timelineInfo{
                .waitSemaphoreValueCount =
                    0, // We'll still use binary semaphore for swapchain
                .signalSemaphoreValueCount = 1,
                .pSignalSemaphoreValues = &signalValue};

            std::array<vk::Semaphore, 2> waitSemaphores = {
                *presentCompleteSemaphore[currentFrame], *timelineSemaphore};
            std::array<vk::PipelineStageFlags, 2> waitStages = {
                vk::PipelineStageFlagBits::eColorAttachmentOutput,
                vk::PipelineStageFlagBits::eVertexInput};
            std::array<uint64_t, 2> waitValues = {
                0, waitValue}; // Binary semaphore value is ignored

            std::array<vk::Semaphore, 2> signalSemaphores = {
                *renderFinishedSemaphore[currentFrame], *timelineSemaphore};
            std::array<uint64_t, 2> signalValues = {
                0, signalValue}; // Binary semaphore value is ignored
            ...
            vk::SubmitInfo submitInfo{.pNext = &timelineInfo,
                                      .waitSemaphoreCount =
                                          1, // Only wait on the binary semaphore
    ...
    [[nodiscard]] std::vector<const char *> getRequiredExtensions() const
    {
        ...
        {
            std::cout << "VK_EXT_debug_utils extension not available. Validation layers "
                         "may not work."
                      << std::endl;
        }
