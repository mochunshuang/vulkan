...
class HelloTriangleApplication
{
  ...
  private:
    ...
    void createLogicalDevice()
    {
        ...
        {
            // the graphicsIndex doesn't support present -> look for another family index
    ...
    void createGraphicsPipeline()
    {
        vk::raii::ShaderModule vertshaderModule =
            createShaderModule(readFile("shaders/test_triangle_vert.spv"));
        vk::raii::ShaderModule fragshaderModule =
            createShaderModule(readFile("shaders/test_triangle_frag.spv"));
