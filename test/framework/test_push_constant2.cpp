...
{
    glm::vec2 positions[4]; // 4个顶点位置，每个8字节
    glm::vec3 colors[4];    // 4个顶点颜色，每个12字节
    uint8_t padding[12];    // 填充到92字节（32+48+12=92）
};

constexpr auto VERT_SHADER_PATH = "shaders/test_push_constant2_vert.spv";
...
int main()
{
    try
    {
        ...
        auto recordCommandBuffer = [&](VkCommandBuffer commandBuffer,
            ...
            // 推送常量数据 - 正方形的顶点属性
            PushConstants pushConstants{.positions =
                                            {
                                                glm::vec2(-0.5f, -0.5f), // 顶点0
                                                glm::vec2(0.5f, -0.5f),  // 顶点1
                                                glm::vec2(0.5f, 0.5f),   // 顶点2
                                                glm::vec2(-0.5f, 0.5f)   // 顶点3
                                            },
                                        .colors = {
                                            glm::vec3(1.0f, 0.0f, 0.0f), // 红色 - 顶点0
                                            glm::vec3(0.0f, 1.0f, 0.0f), // 绿色 - 顶点1
                                            glm::vec3(0.0f, 0.0f, 1.0f), // 蓝色 - 顶点2
                                            glm::vec3(1.0f, 0.0f, 0.0f)  // 红色 - 顶点3
                                        }};
            ...
            // 关键：绑定索引缓冲区并使用 vkCmdDrawIndexed
