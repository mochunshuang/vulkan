...
constexpr auto VERT_SHADER_PATH = "shaders/test_backend_uniform_vert.spv";
...
try
{
    ...
    auto descriptorPool = DescriptorPool(
        ...
        {.flags = VK_DESCRIPTOR_POOL_CREATE_FREE_DESCRIPTOR_SET_BIT,
         ...
         .poolSizes = {VkDescriptorPoolSize{.type = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER,
    ...
    {
        uniformBuffers[i] = create_buffer(ctx.logicalDevice(),
        ...
        uniformBuffersMapped[i] = uniformBuffers[i].map(BUFFER_SIZE);
    }
