...
constexpr auto TITLE = "Scene Test with Color Picking";
constexpr int MAX_FRAMES_IN_FLIGHT = 2;
constexpr auto VERT_SHADER_PATH = "shaders/test_select_vert.spv";
    ...
    try
    {
        ...
        auto instance = make_instance{}
                            ...
                            .build({.sType = sType<VkApplicationInfo>(),
                                    .pApplicationName = "Scene Test with Color Picking",
        ...
        std::println("\n=== Scene Test with Color Picking Started ===");
        ...
        std::println("\n=== Scene Test with Color Picking Finished ===");
    }
